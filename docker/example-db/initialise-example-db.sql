...
--
-- Host: localhost    Database: example-db
-- ------------------------------------------------------
...
--
-- Dumping events for database 'example-db'
--

--
-- Dumping routines for database 'example-db'
--
